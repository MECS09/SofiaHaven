        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                    @include('inc.alert')
                    <h1 class="mt-5 text-center">Create New Chapter for {{$book->title}}!</h1>
                    <!-- Default form contact -->
                    <form class="p-5" action="{{route('chapter.store')}}" method="POST"  enctype="multipart/form-data">
                        @csrf
                        
                        <input type="text" id="Chapter-title" name="story_id"value="{{$book->id}}" class="form-control mb-4 d-none">
                        <input type="text" id="Chapter-title" name="story_name" value="{{$book->title}}" class="form-control mb-4 d-none">
                        <!-- Name -->
                        ...
                        <div class="input-group mb-3 px-2 py-2 rounded-pill bg-white shadow-sm">
                            <input id="upload" type="file" name="chapter_cover" onchange="readURL(this);" class="form-control border-0">
