        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                    @include('inc.alert')
                    <h1 class="mt-5 text-center">Create New Blog!</h1>
                    ...
                    <form class="p-5" action="{{route('blog.store')}}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="input-group mb-3 px-2 py-2 rounded-pill bg-white shadow-sm">
                            ...
                            <label id="upload-label" for="upload" class="font-weight-light text-muted">Blog Cover</label>
                        ...
                        <select class="browser-default custom-select mb-4" name="category" required>
